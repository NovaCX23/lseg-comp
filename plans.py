...
#        Gemini a spus
# Pentru a face diagrama editabilă, cea mai elegantă și profesională metodă în Streamlit este să transformăm aplicația într-un fel de IDE (Mediu de Dezvoltare) cu două coloane:

# În stânga: Chat-ul cu AI-ul.

# În dreapta: Un editor de text live + diagrama vizuală.

# Astfel, AI-ul generează structura de bază, iar tu o poți modifica manual din editorul din dreapta (schimbi un nume, o săgeată etc.), iar diagrama se va actualiza în timp real, fără să mai ceri AI-ului să o genereze din nou.
